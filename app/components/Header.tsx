...
const Header = () => {
  ...
  return (
    ...
    >
      <Container>
        <MotionDiv whileHover={{ color: 'var(--sage)' }}>
          The Johnson Kow
        </MotionDiv>
        <NavigationLinks
          isMobile={isMobile}
          ...
          handleScroll={scrollToComponent}
        />
      </Container>
      <MobileDropdownMenu
        showDropdown={showDropdown}
  ...
  return (
    <>
      <MotionDiv
        ...
        onClick={() => handleClick('experience', 0)}
      >
        Work
      </MotionDiv>
      <MotionDiv
        whileHover={hoverStyle}
        onClick={() => handleClick('contact', 0)}
      >
        Contact
      </MotionDiv>
      <MotionDiv
        whileHover={hoverStyle}
        onClick={() => handleClick('about', 0)}
      >
        About
      </MotionDiv>
      <MotionDiv
